    ...
    <div className="product-card">
      <div className="product-img-wrap">
        ...
        <div className="product-actions">
          ...
          <Link href={`/product/${encodeURIComponent(id)}`} className="product-action-btn pa-secondary">
            Quick View
          </Link>
        </div>
      </div>
    ...
    <>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <Link href="/shop" className="hero-btn">Explore Collection</Link>
        </div>
      </section>
      ...
      <section className="section">
        ...
        <div className="cat-grid">
          {CATEGORIES.map(c => (
            <Link key={c.cat} href={`/shop?cat=${c.cat}`} className="cat-card">
      ...
      <section className="section section-alt">
        <div className="section-inner">
          <div className="section-header">
            ...
            <p className="section-desc">Pieces our customers can not stop wearing.</p>
          </div>
          ...
          <div className="center">
            <Link href="/shop" className="btn-outline-center">View All Jewelry</Link>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="promo-grid">
          <Link href="/shop?cat=Necklaces" className="promo-card">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="https://images.unsplash.com/photo-1599643477877-530eb83abc8e?w=800&q=85" alt="Necklaces" />
            <div className="promo-content">
              <h3 className="promo-title">Timeless Necklaces</h3>
              <span className="promo-link">Shop Now →</span>
            </div>
          </Link>
          <Link href="/shop?cat=Rings" className="promo-card">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=800&q=85" alt="Rings" />
            <div className="promo-content">
              <h3 className="promo-title">Statement Rings</h3>
              <span className="promo-link">Shop Now →</span>
            </div>
          </Link>
        </div>
      ...
      <section className="section">
        <div className="section-header">
          ...
          <p className="section-desc">Fresh pieces added to our collection.</p>
        </div>
      ...
      <section className="testimonials-section">
        <div className="section-header" style={{ padding: '0 40px', marginBottom: '40px' }}>
          <h2 className="section-title">What Our Customers Say</h2>
        </div>
        <div className="testimonials-track-outer">
          <div className="testimonials-track">
            {[...Array(2)].flatMap(() => [
              { name: 'Priya S.', text: 'The earrings are stunning. Received so many compliments!', rot: '-3deg' },
              { name: 'Ananya M.', text: 'Absolutely love my necklace. Quality is exceptional.', rot: '2deg' },
              { name: 'Kavya R.', text: 'Bought as a gift and my sister loved it. Will buy again!', rot: '-1.5deg' },
              { name: 'Sneha P.', text: 'Fast shipping, beautiful packaging, gorgeous jewelry.', rot: '3deg' },
              { name: 'Riya J.', text: 'The ring fits perfectly. So elegant and lightweight.', rot: '-2deg' },
            ]).map((t, i) => (
              <div key={i} className="polaroid-card" style={{ '--rot': t.rot } as React.CSSProperties}>
                <div className="polaroid-clip" />
                <div className="polaroid-inner">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={`https://images.unsplash.com/photo-${1535632066927 + i * 1000}?w=300&q=80`} alt="" onError={e => { (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=300&q=80'; }} />
                </div>
      ...
      <style>{`
        ...
        .section-alt { background: #effcff; padding: 80px 40px; }
        .section-inner { max-width: 1300px; margin: 0 auto; }
        .section-header { text-align: center; margin-bottom: 56px; }
        .section-title { font-family: var(--font-head); font-size: clamp(28px, 4vw, 36px); font-weight: 400; margin-bottom: 16px; }
        ...
        .cat-name { font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.1em; }
        ...
        .product-name { font-family: var(--font-head); font-size: 16px; font-weight: 500; }
        ...
        .promo-link { font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.1em; border-bottom: 1px solid #fff; padding-bottom: 4px; transition: color 0.3s; }
        ...
        .polaroid-card { background: #fff0f0; padding: 14px 14px 22px; width: 240px; box-shadow: 3px 4px 18px rgba(0,0,0,0.13); transform: rotate(var(--rot, 0deg)); transition: transform 0.3s, box-shadow 0.3s; flex-shrink: 0; }
        .polaroid-card:hover { transform: rotate(0deg) scale(1.05); box-shadow: 6px 10px 30px rgba(0,0,0,0.2); }
        .polaroid-clip { position: relative; top: -14px; left: 50%; transform: translateX(-50%); width: 22px; height: 28px; background: #888; border-radius: 3px 3px 0 0; margin-bottom: -14px; }
        ...
        .polaroid-text { font-size: 11.5px; color: #555; line-height: 1.6; }
